...
namespace KNInet {
	...
	Katana::~Katana() {
		...
		if(comm) delete comm;
		if(socket) delete comm;
	}
	////////////////////////////////////////////////////////////////////////////////////////
	Katana::Katana(System::String ^ipAddress, System::String ^port, System::String ^configurationFile) :
		...
		try {
			socket = new CCdlSocket(const_cast<char*>(ip.c_str()), atoi(portno.c_str()));
